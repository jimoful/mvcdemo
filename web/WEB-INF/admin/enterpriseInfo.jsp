...
<div id="page-main" style="backgroud:#104d74;">
		...
		<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/admin/updateEnterpriseInfo.do">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input name="email" type="text" class="form-control" id="realname"
