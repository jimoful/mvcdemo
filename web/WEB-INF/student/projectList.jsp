...
<c:forEach items="${pageBean.list }" var="pro">
	...
	<nav class="col-md-10 col-md-offset-2">
		<ul class="pagination">
<li><a href="${pageContext.request.contextPath }/student/findAllProjectList.do?page=1">首页</a></li>

			<c:choose>
				<c:when test="${pageBean.curPage!=1 }">
					<li><a href="${pageContext.request.contextPath }/student/findAllProjectList.do?page=${pageBean.curPage-1 }"><span>&laquo;</span></a></li>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${pageBean.allPage<=10 }">
					<c:forEach begin="1" end="${ pageBean.allPage}" var="i">
						<li class="pageNum"><a href="${pageContext.request.contextPath }/student/findAllProjectList.do?page=${i }">${i }</a></li>
					</c:forEach>
				</c:when>
			...
			<c:choose>
				<c:when test="${pageBean.curPage!=pageBean.allPage }">
					<li><a href="${pageContext.request.contextPath }/student/findAllProjectList.do?page=${pageBean.curPage+1 }"><span>&raquo;</span></a></li>
				</c:when>
				<c:otherwise>
			...
			<li><a href="${pageContext.request.contextPath }/student/findAllProjectList.do?page=${pageBean.allPage}">尾页</a></li>
		</ul>
	</nav>
