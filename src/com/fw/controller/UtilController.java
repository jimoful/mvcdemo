...
public class UtilController {
	...
	public String load(String fileName, HttpServletRequest request,
			HttpServletResponse response) throws Exception {

		fileName = new String(fileName.getBytes("iso8859-1"), "utf-8");
		File file = new File("D:/Program Files/upload" + fileName);
		if (file.exists()) {
	...
	@RequestMapping(value = "ajaxCheckverificationCode.do", produces = "text/html;charset=UTF-8")
	public @ResponseBody
	String ajaxCheckverificationCode(String verificationCode,
			HttpSession session) {
